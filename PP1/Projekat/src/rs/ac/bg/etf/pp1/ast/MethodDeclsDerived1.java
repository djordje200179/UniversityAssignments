...
public class MethodDeclsDerived1 extends MethodDecls {

    private MethodDecls MethodDecls;
    private MethodDecl MethodDecl;

    public MethodDeclsDerived1 (MethodDecls MethodDecls, MethodDecl MethodDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclsDerived1(\n");
