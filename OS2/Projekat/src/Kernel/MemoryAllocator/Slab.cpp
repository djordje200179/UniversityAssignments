...
static void* Kernel::MemoryAllocators::Slab::operator new(size_t size, size_t typeSize, size_t numOfSlots) {
...
static void Kernel::MemoryAllocators::Slab::operator delete(void* ptr) {
