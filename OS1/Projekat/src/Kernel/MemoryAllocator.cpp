...
void* Kernel::MemoryAllocator::allocate(size_t blocks) {
...
void Kernel::MemoryAllocator::deallocate(void* ptr) {
...
void Kernel::MemoryAllocator::MemorySegment::tryJoinWithNext() {
